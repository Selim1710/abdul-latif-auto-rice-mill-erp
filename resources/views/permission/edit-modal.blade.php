          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="{{__('file.Name')}}" name="name" required="required" col="col-md-12" placeholder="Enter name" onkeyup="url_generator(this.value,'slug')"/>
                    <x-form.textbox labelName="{{__('file.Slug')}}" name="slug" required="required" col="col-md-12" placeholder="Enter slug"/>
                </div>
            </div>
            <!-- /modal body -->
