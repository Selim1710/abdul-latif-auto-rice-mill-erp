        ...
        <form id="store_or_update_form" method="post">
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    <x-form.selectbox labelName="{{__('file.Module')}}" name="module_id" required="required" col="col-md-12" class="selectpicker">
                      @if (!empty($modules))
                    ...
                    <div class="col-md-12">
                      <table class="table table-borderless" id="permission-table">
                        <thead class="bg-primary">
                          <tr>
                            <th width="45%">{{__('file.Permission Name')}}</th>
                            <th width="45%">{{__('file.Permission Slug')}}</th>
                            <th width="10%"></th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <button type="button" id="add_permission" class="btn btn-primary btn-sm btn-elevate btn-icon" data-toggle="tooltip" data-theme="dark" title="{{__('file.Add More')}}">
