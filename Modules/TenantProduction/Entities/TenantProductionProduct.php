...
{
    protected $fillable = ['invoice_no', 'date', 'tenant_production_id', 'warehouse_id', 'product_id', 'qty', 'scale', 'production_qty', 'use_warehouse_id', 'use_product_id', 'use_qty','batch_no'];
