                    ...
                    <div class="card-toolbar">
                        <div>
                            ...
                            @if (permission('tenant-production-show'))
                                <span><a href="{{ route('tenant.production.show', $production->id) }}"
                            ...
                            @if (permission('tenant-production-access'))
                                <span><a href="{{ route('tenant.production') }}"
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.next_button', function() {
            ...
            if (type == 'milling') {
                for (let j = 0; j < $('.rate').length; j++) {
                    if (__('useQty')[j].value == '' || __('useScale')[j].value == '' || __('useProQty')[j].value ==
                        '' || __('rate')[j].value == '') {
        ...
        $(document).on('click', '.addRaw', function() {
            ...
            html = `<tr class="text-center">
                       <td>
                       <select class="form-control selectpicker" id="merge_` + i + `_warehouse_id" name="merge[` + i +
                `][warehouse_id]" data-product_id = "merge_` + i + `_product_id" data-live-search="true">
                       ...
                       <td>
                       <select class="form-control selectpicker mergeCategory" id="merge_` + i +
                `_category_id" data-warehouse_id="merge_` + i + `_warehouse_id" data-product_id = "merge_` + i + `_product_id" data-live-search="true">
                       <option value="" selected>{{ __('file.Select Please') }}</option>
                       ...
                       <td>
                       <select class="form-control product selectpicker mergeProduct" id="merge_` + i +
                `_product_id" data-warehouse_id="merge_` + i + `_warehouse_id" data-unit_id_show = "merge_` + i +
                `_unit_id_show" data-unit_id = "merge_` + i + `_unit_id" data-price = "merge_` + i +
                `_price" data-available_qty = "merge_` + i + `_available_qty" name="merge[` + i + `][product_id]" data-live-search="true"></select>
                       </td>
                       <td>
                       ...
                       <td><input type="text" class="form-control qty" id="merge_` + i + `_qty" name="merge[` + i +
                `][qty]" data-product_id = "merge_` + i + `_product_id" data-available_qty = "merge_` + i +
                `_available_qty" data-unit_id = "merge_` + i + `_unit_id" data-scale="merge_` + i + `_scale"/></td>
                       <td><input type="text" class="form-control merScale" id="merge_` + i + `_scale" name="merge[` +
                i + `][scale]" data-product_id = "merge_` + i + `_product_id" data-available_qty = "merge_` + i +
                `_available_qty" data-unit_id = "merge_` + i + `_unit_id" data-qty="merge_` + i + `_qty"/></td>
                       <td><input type="text" class="form-control merQty" id="merge_` + i + `_mer_qty" name="merge[` +
                i + `][mer_qty]" data-product_id = "merge_` + i + `_product_id" data-available_qty = "merge_` + i + `_available_qty"/></td>
                       <td><input type="text" class="form-control merRate" id="merge_` + i + `_rate" name="merge[` +
                i + `][rate]" data-use_scale="merge_` + i + `_scale" data-milling="merge_` + i + `_milling"/></td>
                       <td><input type="text" class="form-control milling bg-primary" id="merge_` + i +
                `_milling" name="merge[` + i + `][milling]" readonly/> </td>
