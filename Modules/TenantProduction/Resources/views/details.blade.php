                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                ...
                                                <th><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Production Batch No') }}</button>
                                                </th>
                                                <th>{{ $data->production_batch_no }}</th>

                                                <th><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Tenant Production Batch No') }}</button>
                                                </th>
                                                <th>{{ $data->batch_no }}</th>

                                                <th><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Production Type') }}</button>
                                                </th>
                                    ...
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                            @if (!$data->rawList->isEmpty())
                                                @foreach ($data->rawList as $key => $item)
                                                    <tr class="text-center">
                                                        <td class="no">{{ $key + 1 }}</td>
                                                        <td class="no">{{ $item->warehouse->name }}</td>
                                                        <td class="no">{{ $item->batch_no ?? '' }}</td>
