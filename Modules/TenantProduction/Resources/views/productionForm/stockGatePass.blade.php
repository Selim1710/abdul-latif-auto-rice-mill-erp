                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <h4 class="name m-0">#{{ $product->productionProductList[0]->invoice_no }}</h4>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($product->productionProductList[0]->date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                        @if (!$product->productionProductList->isEmpty())
                                            @foreach ($product->productionProductList as $key => $item)
                                                <tr class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $product->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($product->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
