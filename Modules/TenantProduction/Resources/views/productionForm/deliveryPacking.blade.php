                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="to">{{ $delivery->production->tenant->name }}</div>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $delivery->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($delivery->date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table>
                                        <thead>
                                        <tr><td><button type="button" class="btn btn-success btn-block">{{__('file.Delivery')}}</button></td></tr>
                                        </thead>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th>{{__('file.Scale')}}</th>
                                            <th>{{__('file.Del Qty')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if (!$delivery->deliveryProductList->isEmpty())
                                            @foreach ($delivery->deliveryProductList as $key => $item)
                                                <tr class="text-center">
                                    ...
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                        @if (!$delivery->mergeDeliveryProductList->isEmpty())
                                            @foreach ($delivery->mergeDeliveryProductList as $key => $item)
                                                <tr class="text-center">
                                                    <td class="no">{{ $key+1 }}</td>
