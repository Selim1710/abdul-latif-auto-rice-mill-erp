<div class="row">
    <div class="col-md-12 py-5">
        ...
        <table class="table table-bordered millingTableAppend" id="millingTableAppend">
            ...
            <tr class="text-center">
                <td>
                    <select class="form-control selectpicker" id="merge_0_warehouse_id" name="merge[0][warehouse_id]" data-product_id = "merge_0_product_id" data-live-search="true">
                ...
                <td>
                    <select class="form-control selectpicker mergeCategory" id="merge_0_category_id" data-warehouse_id="merge_0_warehouse_id" data-product_id = "merge_0_product_id" data-live-search="true">
                        <option value="" selected>{{__('file.Select Please')}}</option>
