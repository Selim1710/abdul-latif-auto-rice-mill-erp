                        ...
                        <div id="invoice">
                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light"><b>{{__('file.Stock')}}</b></div>
                                                    <h4 class="name m-0">#{{ $products[0]->production->invoice_no }}</h4>
                                                    <h4 class="name m-0">#{{ $products[0]->invoice_no }}</h4>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($products[0]->production->date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table>
                                        <thead>
                                        <tr><td><button type="button" class="btn btn-success btn-block">{{__('file.Product')}}</button></td></tr>
                                        </thead>
                                    </table>
                                        ...
                                        @if (!$products->isEmpty())
                                            @foreach ($products as $key => $item)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no">{{ $item->production_qty }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
                                    ...
                                    <table>
                                        <thead>
                                        <tr><td><button type="button" class="btn btn-success btn-block">{{__('file.Use Product')}}</button></td></tr>
                                        </thead>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        <thead>
                                        ...
                                        @if (!$products->isEmpty())
                                            @foreach ($products as $key => $item)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no">{{ $item->useProduct->category->category_name }}</td>
                                    ...
                                    <table>
                                        <thead>
                                        <tr><td><button type="button" class="btn btn-success btn-block">{{__('file.Merge')}}</button></td></tr>
                                        </thead>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        <thead>
                                        ...
                                        <tbody>
                                        @if (!$products[0]->mergeProductionProductList->isEmpty())
                                            @foreach ($products[0]->mergeProductionProductList as $key => $item)
                                                <tr class="text-center">
                                                    <td class="no">{{ $key+1 }}</td>
                                                    <td class="no">{{ $item->warehouse->name }}</td>
                                                    <td class="no">{{ $item->product->product_name }}</td>
                                                    <td class="no">{{ $item->product->category->category_name }}</td>
                                                    <td class="no">{{ $item->product->unit->unit_name.'('.$item->product->unit->unit_code.')' }}</td>
                                                    <td class="no">{{ $item->price }}</td>
                                                    <td class="no">{{ $item->qty }}</td>
                                                    <td class="no">{{ $item->sub_total }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $products[0]->production->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($products[0]->production->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
