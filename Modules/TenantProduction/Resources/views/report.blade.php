            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('tenant.production') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light"><b>{{ __('file.Tenant Production') }}</b>
                                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="9"><button type="button"
                                                        class="btn btn-success btn-block">{{ __('file.Raw') }}</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="no"><button type="button"
                                                ...
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Qty') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Scale') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Pro Qty') }}</button>
                                                </td>
                                            </tr>
                                            @foreach ($data->rawList as $raw)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no">
                                                        {{ $raw->product->unit->unit_name . '(' . $raw->product->unit->unit_code . ')' }}
                                                    </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="3"><button type="button"
                                                        class="btn btn-success btn-block">{{ __('file.Expense') }}</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.SL') }}</button></td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Expense Item') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Expense Cost') }}</button>
                                                </td>
                                            </tr>
                                    ...
                                    {{-- <table>
                                        <tbody>
                                            <tr>
                                                <td colspan="9"><button type="button"
                                                        class="btn btn-success btn-block">{{ __('file.Delivery') }}</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="no"><button type="button"
                                                ...
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Warehouse') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Product') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Unit') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Use Qty') }}</button>
                                                </td>
                                            ...
                                            @forelse($data->deliveryList as $delivery)
                                                @foreach ($delivery->deliveryProductList as $item)
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="no"><span
                                                                class="label label-danger label-pill label-inline"
                                                                style="min-width:70px !important;">{{ $item->product->category->category_name }}</span>
                                                        </td>
                                                        <td class="no">
                                                        ...
                                                        <td class="no">
                                                            {{ $item->useProduct->unit->unit_name . '(' . $item->useProduct->unit->unit_code . ')' }}
                                                        </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td class="no" colspan="9"><button type="button"
                                                            class="btn btn-danger btn-block">{{ __('file.No Data Found') }}</button>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="10"><button type="button"
                                                        class="btn btn-success btn-block">{{ __('file.Stock') }}</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="no"><button type="button"
                                            ...
                                            @foreach ($data->productList as $product)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no"><span
                                                            class="label label-danger label-pill label-inline"
                                                            style="min-width:70px !important;">{{ $product->product->category->category_name }}</span>
                                                    </td>
                                                    <td class="no">
                                                        {{ $product->product->unit->unit_name . '(' . $product->product->unit->unit_code . ')' }}
                                                    </td>
                                                    ...
                                                    <td class="no">
                                                        {{ $product->useProduct->unit->unit_name . '(' . $product->useProduct->unit->unit_code . ')' }}
                                                    </td>
                                    ...
                                    {{-- <table>
                                        <tbody>
                                            <tr>
                                                <td colspan="12"><button type="button"
                                                        class="btn btn-success btn-block">{{ __('file.Merge') }}</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Invoice No') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Warehouse') }}</button>
                                                </td>
                                                ...
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Mer Qty') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Sub Total') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Milling') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Type') }}</button>
                                                </td>
                                            </tr>
                                            @foreach ($data->mergeProductList as $merge)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no">
                                                        {{ $merge->product->product_name }}<br />{{ $merge->product->unit->unit_name . '(' . $merge->product->unit->unit_code . ')' }}
                                                    </td>
                                                    <td class="no">{{ $merge->product->category->category_name }}
                                                    </td>
