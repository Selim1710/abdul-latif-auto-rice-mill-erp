                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr class="text-center">
                                            <td class="no"><button class="btn btn-primary btn-block">{{__('file.Total Delivery Scale')}}</button></td>
                                            <td class="no"><h5>{{$data->total_delivery_scale}}</h5></td>
                                        </tr>
                                        <tr class="text-center">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="no"><h5>{{ $data->total_stock_scale + $data->total_delivery_scale}}</h5></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td class="no"><button class="btn btn-primary btn-block">{{__('file.Total Waste')}}</button></td>
                                            <td class="no"><h5>{{ $data->total_raw_scale - $data->total_stock_scale + $data->total_delivery_scale}}</h5></td>
                                        </tr>
                                        </tbody>
                                    </table>
