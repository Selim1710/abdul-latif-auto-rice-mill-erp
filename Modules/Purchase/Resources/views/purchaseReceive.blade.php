                                            ...
                                            <table class="table table-bordered quarterSelectTable" id="saleTable">
                                                ...
                                                @foreach($purchase->purchaseProductList as $key => $item)
                                                    ...
                                                    <tr class="text-center">
                                                        <td>
                                                            <select class="form-control bg-primary text-center text-white" id="receive_{{$key}}_warehouse_id" name="receive[{{$key}}][warehouse_id]">
                                                                <option value="{{$item->warehouse->id}}">{{$item->warehouse->name}}</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <select class="form-control bg-primary text-center text-white" id="receive_{{$key}}_product_id" name="receive[{{$key}}][product_id]">
                                                                <option value="{{$item->product->id}}">{{$item->product->product_name}}</option>
                                                            </select>
                                                        </td>
                                                        <td><input type="text" class="form-control text-center bg-primary text-white" id="receive_{{$key}}_unit_name" name="receive[{{$key}}][unit_name]" value="{{$item->product->unit->unit_name.'('.$item->product->unit->unit_code.')'}}" readonly/></td>
                                                        <td><input type="text" class="form-control text-center price bg-primary text-white" id="receive_{{$key}}_price" name="receive[{{$key}}][price]" value="{{$item->sub_total / $item->rec_qty}}" readonly/></td>
                                                        <td>
                                                            <input type="hidden" name="receive[{{$key}}][scale]" value="{{$item->scale}}"/>
                                                            <input type="text" class="form-control text-center bg-primary text-white" id="receive_{{$key}}_purchase_qty" name="receive[{{$key}}][purchase_qty]" value="{{$item->rec_qty}}" readonly/>
                                                        </td>
                                                        <td><input type="text" class="form-control text-center bg-primary text-white" id="receive_{{$key}}_received_qty" value="{{$item->receive_qty}}" readonly/></td>
                                                        ...
                                                        <td><input type="text" class="form-control text-center subTotal bg-primary text-white" id="receive_{{$key}}_sub_total" name="receive[{{$key}}][sub_total]" readonly/></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
                                ...
                                <div class="col-md-3">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-white text-center" id="total_receive_qty" name="total_receive_qty" readonly/> </td>
                                        </tr>
                                        <tr>
                                            <td><button class="btn btn-primary btn-block">{{__('file.Receive Total')}}</button></td>
                                            <td><input type="text" class="form-control bg-primary text-white text-center" id="total_receive_sub_total" name="total_receive_sub_total" readonly/> </td>
                                        </tr>
                                    </table>
                                </div>
