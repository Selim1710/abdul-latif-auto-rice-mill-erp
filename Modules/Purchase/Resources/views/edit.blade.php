                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control selectpicker" id="purchase_status" name="purchase_status"
                                        ...
                                        @foreach (PURCHASE_STATUS_VALUE as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $edit->purchase_status) selected="selected" @endif>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="text-center">
                                                                <td>
                                                                    <select
                                                                        ...
                                                                        id="purchase_{{ $key }}_warehouse_id"
                                                                        name="purchase[{{ $key }}][warehouse_id]"
                                                                        index_no="{{ $key }}"
                                                                        data-live-search = "true">
                                                                        <option value="{{ $product->warehouse_id }}">
                                                                            {{ $product->warehouse->name }}</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select
                                                                        class="form-control selectpicker category text-center"
                                                                        id="purchase_{{ $key }}_category_id"
                                                                        data-product_id="purchase_{{ $key }}_product_id"
                                                                        data-live-search = "true">
                                                                        <option
                                                                ...
                                                                <td>
                                                                    <select
                                                                        ...
                                                                        id="purchase_{{ $key }}_product_id"
                                                                        name="purchase[{{ $key }}][product_id]"
                                                                        data-unit_show="purchase_{{ $key }}_unit_show"
                                                                        data-unit_id="purchase_{{ $key }}_unit_id"
                                                                ...
                                                                <td><input class="form-control bg-primary text-center"
                                                                        id="purchase_{{ $key }}_unit_show"
                                                                        value="{{ $product->product->unit->unit_name . '(' . $product->product->unit->unit_code . ')' }}"
                                                                        readonly /><input type="hidden"
                                                                        id="purchase_{{ $key }}_unit_id"
                                                                        value="{{ $product->product->unit->unit_name }}" />
                                                                </td>
                                                                <td><input class="form-control qty text-center"
                                                                        id="purchase_{{ $key }}_qty"
                                                                        name="purchase[{{ $key }}][qty]"
                                                                        data-product_id="purchase_{{ $key }}_product_id"
                                                                        data-unit_id="purchase_{{ $key }}_unit_id"
                                                                        data-scale="purchase_{{ $key }}_scale"
                                                                        data-price="purchase_{{ $key }}_price"
                                                                        data-sub_total="purchase_{{ $key }}_sub_total"
                                                                        value="{{ $product->qty }}" /></td>
                                                                <td><input class="form-control scale text-center"
                                                                        id="purchase_{{ $key }}_scale"
                                                                        name="purchase[{{ $key }}][scale]"
                                                                        data-product_id="purchase_{{ $key }}_product_id"
                                                                        data-unit_id="purchase_{{ $key }}_unit_id"
                                                                        data-qty="purchase_{{ $key }}_qty"
                                                                        data-price="purchase_{{ $key }}_price"
                                                                        data-sub_total="purchase_{{ $key }}_sub_total"
                                                            ...
                                                            <tr>
                                                                <td><input class="form-control price text-center"
                                                                        id="purchase_{{ $key }}_price"
                                                                        name="purchase[{{ $key }}][price]"
                                                                        data-product_id="purchase_{{ $key }}_product_id"
                                                                        data-qty="purchase_{{ $key }}_qty"
                                                                        data-sub_total="purchase_{{ $key }}_sub_total"
                                                                ...
                                                                <td><input
                                                                        ...
                                                                        id="purchase_{{ $key }}_sub_total"
                                                                        name="purchase[{{ $key }}][sub_total]"
                                                                        readonly value="{{ $product->sub_total }}" />
                                                                </td>
                                                                <td>
                                                                    <input
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    id="total_purchase_qty" name="total_purchase_qty"
                                                    value="{{ $edit->total_purchase_qty }}" readonly /></td>
                                        </tr>
                                        <tr>
                                            <td><button type="button"
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    ...
                                                    value="{{ $edit->total_purchase_sub_total }}" readonly /></td>
                                        </tr>
                                    </table>
                                </div>
