                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light"><b>{{__('file.Return Invoice')}}</b></div>
                                                    <div class="to">{{ $purchaseProductReturn[0]->purchase->party->company_name }}</div>
                                                    <div class="to">{{ $purchaseProductReturn[0]->purchase->party->name }}</div>
                                                    <div class="phone">{{ $purchaseProductReturn[0]->purchase->party->mobile }}</div>
                                                    @if($purchaseProductReturn[0]->purchase->party->email)<div class="email">{{ $purchaseProductReturn[0]->purchase->party->email }}</div>@endif
                                                    @if($purchaseProductReturn[0]->purchase->party->address)<div class="address">{{ $purchaseProductReturn[0]->purchase->party->address }}</div>@endif
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $purchaseProductReturn[0]->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($purchaseProductReturn[0]->return_date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th>{{__('file.Scale')}}</th>
                                            <th>{{__('file.Return')}}</th>
                                            <th>{{__('file.Sub Total')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if (!$purchaseProductReturn->isEmpty())
                                            @foreach ($purchaseProductReturn as $key => $item)
                                                <tr class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $purchaseProductReturn[0]->purchase->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($purchaseProductReturn[0]->purchase->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
