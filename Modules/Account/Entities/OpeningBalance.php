...
class OpeningBalance extends BaseModel {
    ...
    private function get_datatable_query(){
        ...
        $query              = DB::table('transactions as t')
                              ...
                              ->where(['t.voucher_type'   => 'OPENING-BALANCE'])
                              ->select('t.id as id','coh.name as chartOfHeadName', 't.date as date', 't.voucher_no as voucherNo', 't.voucher_type as voucherType', 't.narration as narration','t.debit as debit','t.credit as credit', 't.status as status', 't.created_by as createdBy');
