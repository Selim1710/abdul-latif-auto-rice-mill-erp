...
class Expense extends BaseModel {
    protected $fillable = ['chart_of_head_id','date','voucher_no','voucher_type','narration','debit','credit','status','is_opening','created_by','modified_by'];    protected $table    = 'transactions';
    ...
    private function get_datatable_query(){
        ...
        $query              = DB::table('transactions as t')
                                ...
                                ->where([['t.voucher_type','=','EXPENSE'],['t.debit','>',0]])
                                ->select('coh.name as chartOfHeadName', 't.date as date', 't.voucher_no as voucherNo', 't.voucher_type as voucherType',
                                    't.narration as narration', 't.status as status', 't.created_by as createdBy','t.debit as totalDebit','t.debit as totalCredit'
                                )
