...
class ReceivePayment extends BaseModel{
    ...
    private function get_datatable_query(){
        ...
        $query              = DB::table('transactions as t')
                              ...
                              ->where([['t.voucher_type','=','COLLECTION'],['t.credit','>',0]])
                              ->select(
                                'coh.name as chartOfHeadName',
                                't.date as date', 't.voucher_no as voucherNo',
                                't.voucher_type as voucherType', 't.narration as narration',
                                't.status as status', 't.created_by as createdBy',
                                't.credit as totalCredit','t.credit as totalDebit'
                              )
