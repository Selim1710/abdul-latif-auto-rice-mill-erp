            ...
            <form id="voucher_form" method="post">
                        ...
                        <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row">
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control bg-primary" name="voucher_no" value=""
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm remove"
                                                        data-type="debit-remove" data-toggle="tooltip" data-placement="top"
                                                        data-original-title="Remove" style="margin-top:3px"> <i
                                                            class="fas fa-minus-square"></i></button>
                                                </td>
                                                <td>
                                                    <select name="debit[0][chart_of_head_id]" id="debit_0_chart_of_head_id"
                                                        ...
                                                        @foreach ($subHeads as $subHead)
                                                            <option value="{{ $subHead->id }}">{!! ($subHead->head->name ?? '') . '  ---  ' . ($subHead->name ?? '') !!}
                                                            </option>
                                                        @endforeach
                                                        @foreach ($childHeads as $child)
                                                            <option value="{{ $child->id }}">{!! ($child->head->name ?? '') . '  ---  ' . ($child->subHead->name ?? '') . '  ---  ' . ($child->name ?? '') !!}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control debitAmount onInput"
                                                        name="debit[0][debit]" id="debit_0_debit" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    <input type="text" class="form-control creditAmount onInput"
                                                        name="credit[0][credit]" id="credit_0_credit" />
                                                </td>
                                                <td>
                                                    <select class="form-control selectpicker"
                                                        id="credit_0_chart_of_head_id" name="credit[0][chart_of_head_id]"
                ...
                <div class="form-group col-md-12 pt-5 text-center">
                    <button type="button" class="btn btn-danger btn-sm mr-3"
                        onclick="window.location.href = '{{ route('voucher.create') }}';"><i class="fas fa-sync-alt"></i>
                        Reset</button>
                    <button type="button" class="btn btn-primary btn-sm mr-3" id="save-btn" onclick="store_data()"><i
