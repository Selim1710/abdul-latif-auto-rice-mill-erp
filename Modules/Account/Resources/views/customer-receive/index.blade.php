                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('customer-receive-add'))
                            <a href="{{ route('customer.receive.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                        @endif
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th style="max-width: 100px;" >{{__('file.Narration')}}</th>
                                            <th>{{__('file.Debit')}}</th>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "{{route('customer.receive.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.change_status', function () {
                ...
                let url    = "{{ route('customer.receive.change.status') }}";
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let name  = $(this).data('name');
                let row   = table.row($(this).parent('tr'));
                let url   = "{{ route('customer.receive.delete') }}";
