                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Account" name="chart_of_head_id" col="col-md-3" class="selectpicker" data-live-search="true">
    ...
    <script>
        ...
        function report_data() {
            ...
            $.ajax({
                ...
                type       :"POST",
                data       :{start_date:start_date,end_date:end_date,chart_of_head_id:chart_of_head_id,_token:_token},
                beforeSend : function(){
