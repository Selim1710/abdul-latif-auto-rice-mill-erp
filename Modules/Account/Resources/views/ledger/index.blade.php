                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Account" name="chart_of_head_id" col="col-md-3"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btn-reset').click(function() {
                ...
                $('#chart_of_head_id').val("");
                $('#chart_of_head_id.selectpicker').selectpicker('refresh');
                $('#report_data').empty();
            });
        });
        ...
        function report_data() {
            ...
            let chart_of_head_id = _('chart_of_head_id').value;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    end_date: end_date,
                    chart_of_head_id: chart_of_head_id,
                    _token: _token
                },
                beforeSend: function() {
