                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    @if($saleProductReturn[0]->sale->party_type == 1)
                                                        <div class="to">{{ $saleProductReturn[0]->sale->party->company_name }}</div>
                                                        <div class="to">{{ $saleProductReturn[0]->sale->party->name }}</div>
                                                        <div class="phone">{{ $saleProductReturn[0]->sale->party->mobile }}</div>
                                                        @if($saleProductReturn[0]->sale->party->email)<div class="email">{{ $saleProductReturn[0]->sale->party->email }}</div>@endif
                                                        @if($saleProductReturn[0]->sale->party->address)<div class="address">{{ $saleProductReturn[0]->sale->party->address }}</div>@endif
                                                    @else
                                                        <div class="to">{{ $saleProductReturn[0]->sale->party_name }}</div>
                                                    @endif
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $saleProductReturn[0]->sale->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($saleProductReturn[0]->sale->sale_date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                        @if (!$saleProductReturn->isEmpty())
                                            @foreach ($saleProductReturn as $key => $item)
                                                <tr class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $saleProductReturn[0]->sale->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($saleProductReturn[0]->sale->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
