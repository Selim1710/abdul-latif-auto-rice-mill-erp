                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-center">
                                                        <td>
                                                            <select
                                                                ...
                                                                id="sale_0_warehouse_id" name="sale[0][warehouse_id]"
                                                        ...
                                                        <td>
                                                            <select class="form-control selectpicker category text-center"
                                                                id="sale_0_category_id"
                                                                data-warehouse_id="sale_0_warehouse_id"
                                                                data-product_id="sale_0_product_id"
                                                                data-live-search = "true">
                                                                <option value="">{{ __('Please Select') }}</option>
                                                        ...
                                                        <td><select class="form-control selectpicker product text-center"
                                                                id="sale_0_product_id" name="sale[0][product_id]"
                                                                data-warehouse_id="sale_0_warehouse_id"
                                                                data-unit_show="sale_0_unit_show"
                                                                data-unit_id="sale_0_unit_id"
                                                                data-available_qty="sale_0_available_qty"
                                                                data-price="sale_0_price"
                                                                data-live-search = "true"></select></td>
                                                        <td><input class="form-control bg-primary text-center"
                                                                id="sale_0_unit_show" readonly /><input type="hidden"
                                                                id="sale_0_unit_id" /></td>
                                                        <td><input
                                                                class="form-control bg-primary available_qty text-center"
                                                                id="sale_0_available_qty" readonly /></td>
                                                        <td><input class="form-control qty text-center" id="sale_0_qty"
                                                                name="sale[0][qty]" data-product_id="sale_0_product_id"
                                                                data-unit_id="sale_0_unit_id"
                                                                data-available_qty="sale_0_available_qty"
                                                                data-scale="sale_0_scale" data-price="sale_0_price"
                                                                data-sub_total="sale_0_sub_total" /></td>
                                                        <td><input class="form-control scale text-center"
                                                                id="sale_0_scale" name="sale[0][scale]"
                                                                data-product_id="sale_0_product_id"
                                                                data-unit_id="sale_0_unit_id"
                                                                data-available_qty="sale_0_available_qty"
                                                                data-qty="sale_0_qty" data-price="sale_0_price"
                                                                data-sub_total="sale_0_sub_total" /> </td>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-control price text-center"
                                                                id="sale_0_price" name="sale[0][price]"
                                                                data-product_id="sale_0_product_id" data-qty="sale_0_qty"
                                                                data-sub_total="sale_0_sub_total" /> </td>
                                                        <td><input class="form-control bg-primary sub_total text-center"
                                                                id="sale_0_sub_total" name="sale[0][sub_total]"
                                                                readonly /> </td>
                                                        <td>
                                                            <input
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    id="total_sale_qty" name="total_sale_qty" readonly /></td>
                                        </tr>
                                        <tr>
                                            <td><button type="button"
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    id="total_sale_sub_total" name="total_sale_sub_total" readonly /></td>
                                        </tr>
                                    </table>
                                </div>
