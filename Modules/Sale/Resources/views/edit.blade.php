            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    @if (permission('sale-access'))
                        <div class="card-toolbar"><a href="{{ route('sale') }}"
                        ...
                        <form action="" id="sale_store_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="date" class="form-control date" id="sale_date" name="sale_date"
                                        value="{{ $edit->sale_date }}" />
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="sale_status">{{ __('file.Sale Status') }}</label>
                                    <select class="form-control selectpicker" id="sale_status" name="sale_status"
                                        data-live-search = "true">
                                        <option value="">{{ __('file.Please Select') }}</option>
                                        @foreach (SALE_STATUS_VALUE as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $edit->sale_status) selected="selected" @endif>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control bg-primary" id="sale_type" disabled>
                                        <option value = "">{{ __('file.Please Select') }}</option>
                                        @foreach (SALE_TYPE_VALUE as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $edit->sale_type) selected="selected" @endif>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" id="sale_type_hidden" name="sale_type"
                                        value="{{ $edit->sale_type }}" />
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control party_id selectpicker" id="party_id" name="party_id"
                                        ...
                                        @foreach ($parties as $party)
                                            <option value="{{ $party->id }}"
                                                @if ($party->id == $edit->party_id) selected="selected" @endif>
                                                {{ $party->name . '(' . $party->address . ')' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control payment_status selectpicker" id="payment_status"
                                        ...
                                        @foreach (PAYMENT_STATUS as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $edit->payment_status) selected="selected" @endif>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control payment_method" id="payment_method" name="payment_method"
                                        ...
                                        @foreach (SALE_PAYMENT_METHOD as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key == $edit->payment_method) selected="selected" @endif>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="text" class="form-control text-center" name="discount"
                                        id="discount" value="{{ $edit->discount }}">
                                </div>
                                <div class="form-group col-md-3 required">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="text" class="form-control text-center" name="paid_amount"
                                        id="paid_amount" value="{{ $edit->paid_amount }}">
                                </div>
                                <div class="form-group col-md-3">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr class="text-center"
                                                            @if ($key != 0) style="border-top: 2px solid cadetblue;" @endif>
                                                            ...
                                                            <th><button type = "button"
                                                                    class="btn btn-primary btn-block">{{ __('file.Sel Qty') }}</button>
                                                            </th>
                                                            <th><button type = "button"
                                                        ...
                                                        <tr class="text-center">
                                                            <td>
                                                                <select
                                                                    ...
                                                                    id="sale_{{ $key }}_warehouse_id"
                                                                    name="sale[{{ $key }}][warehouse_id]"
                                                                    index_no="{{ $key }}"
                                                                    data-live-search = "true">
                                                                    <option value="{{ $value->warehouse_id }}">
                                                                        {{ $value->warehouse->name }}</option>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select
                                                                    class="form-control selectpicker category text-center"
                                                                    id="sale_{{ $key }}_category_id"
                                                                    data-warehouse_id="sale_{{ $key }}_warehouse_id"
                                                                    data-product_id="sale_{{ $key }}_product_id"
                                                                    data-live-search = "true">
                                                                    <option value="{{ $value->product->category_id }}">
                                                            ...
                                                            <td>
                                                                <select
                                                                    ...
                                                                    id="sale_{{ $key }}_product_id"
                                                                    name="sale[{{ $key }}][product_id]"
                                                                    data-warehouse_id="sale_{{ $key }}_warehouse_id"
                                                                    data-unit_show="sale_{{ $key }}_unit_show"
                                                                    data-unit_id="sale_{{ $key }}_unit_id"
                                                                    data-available_qty="sale_{{ $key }}_available_qty"
                                                                    data-price="sale_{{ $key }}_price"
                                                                    data-live-search = "true">
                                                                    <option value="{{ $value->product_id }}">
                                                                        {{ $value->product->product_name }}</option>
                                                                </select>
                                                            </td>
                                                            <td><input class="form-control bg-primary text-center"
                                                                    id="sale_{{ $key }}_unit_show"
                                                                    value="{{ $value->product->unit->unit_name . '(' . $value->product->unit->unit_code . ')' }}"
                                                                    readonly /><input type="hidden"
                                                                    id="sale_{{ $key }}_unit_id"
                                                                    value="{{ $value->product->unit->unit_name }}" /></td>
                                                            <td><input
                                                                    class="form-control bg-primary available_qty text-center"
                                                                    id="sale_{{ $key }}_available_qty"
                                                                    value="{{ $value->availableQty($value->warehouse_id, $value->product_id)->qty ?? 0 }}"
                                                                    readonly /></td>
                                                            <td><input class="form-control qty text-center"
                                                                    ...
                                                                    data-unit_id="sale_{{ $key }}_unit_id"
                                                                    data-available_qty="sale_{{ $key }}_available_qty"
                                                                    data-scale="sale_{{ $key }}_scale"
                                                                    data-price="sale_{{ $key }}_price"
                                                                    data-sub_total="sale_{{ $key }}_sub_total" />
                                                            </td>
                                                            <td><input class="form-control scale text-center"
                                                                    ...
                                                                    data-unit_id="sale_{{ $key }}_unit_id"
                                                                    data-available_qty="sale_{{ $key }}_available_qty"
                                                                    data-qty="sale_{{ $key }}_qty"
                                                                    data-price="sale_{{ $key }}_price"
                                                                    data-sub_total="sale_{{ $key }}_sub_total" />
                                                            </td>
                                                            <td><input class="form-control selQty text-center"
                                                                    id="sale_{{ $key }}_sel_qty"
                                                                    name="sale[{{ $key }}][sel_qty]"
                                                                    value="{{ $value->sel_qty }}"
                                                                    data-available_qty="sale_{{ $key }}_available_qty"
                                                                    data-load_unload_rate="sale_{{ $key }}_load_unload_rate"
                                                                    data-load_unload_amount="sale_{{ $key }}_load_unload_amount" />
                                                            </td>
                                                            <th rowspan="3">
                                                                <button type="button"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input
                                                                    class="form-control bg-primary sub_total text-center"
                                                                    id="sale_{{ $key }}_sub_total"
                                                                    name="sale[{{ $key }}][sub_total]"
                                                                    value="{{ $value->sub_total }}" readonly /> </td>
                                                            <td>
                                                                <input
                                                                    class="form-control bg-primary load_unload_rate text-center"
                                                                    id="sale_{{ $key }}_load_unload_rate"
                                                                    name="sale[{{ $key }}][load_unload_rate]"
                                                                    value="{{ $value->load_unload_rate ?? '' }}"
                                                                    readonly />
                                                            </td>
                                                            <td>
                                                                <input
                                                                    class="form-control bg-primary load_unload_amount text-center"
                                                                    id="sale_{{ $key }}_load_unload_amount"
                                                                    name="sale[{{ $key }}][load_unload_amount]"
                                                                    value="{{ $value->load_unload_amount ?? '' }}"
                                                                    readonly />
                                                            </td>
                                ...
                                <div class="col-md-4">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    id="total_sale_qty" name="total_sale_qty"
                                                    value="{{ $edit->total_sale_qty }}" readonly /></td>
                                        </tr>
                                        <tr>
                                            <td><button type="button"
                                            ...
                                            <td><input type="text" class="form-control bg-primary text-center"
                                                    id="total_sale_sub_total" name="total_sale_sub_total"
                                                    value="{{ $edit->total_sale_sub_total }}" readonly /></td>
                                        </tr>
                                    </table>
                                </div>
    ...
    <script>
        ...
        $(document).on('click', '.addRaw', function() {
            ...
            html = `<table class="table">
                ...
                `_category_id" data-warehouse_id="sale_` + i + `_warehouse_id" data-product_id="sale_` + i + `_product_id" data-live-search = "true">
                             ...
                             <td><select class="form-control selectpicker product text-center" id="sale_` + i +
                `_product_id" name="sale[` + i + `][product_id]" data-warehouse_id="sale_` + i +
                `_warehouse_id" data-unit_show="sale_` + i + `_unit_show" data-unit_id="sale_` + i +
                `_unit_id" data-available_qty="sale_` + i + `_available_qty" data-price="sale_` + i + `_price" data-live-search = "true"></select></td>
                             <td><input class="form-control bg-primary text-center" id="sale_` + i +
                `_unit_show" readonly/><input type="hidden" id="sale_` + i + `_unit_id"/></td>
                             <td><input class="form-control bg-primary available_qty text-center" id="sale_` + i + `_available_qty" readonly/></td>
                             <td><input class="form-control qty text-center" id="sale_` + i + `_qty" name="sale[` + i +
                `][qty]" data-product_id="sale_` + i + `_product_id" data-unit_id="sale_` + i +
                `_unit_id" data-available_qty="sale_` + i + `_available_qty" data-scale="sale_` + i +
                `_scale" data-price="sale_` + i + `_price" data-sub_total="sale_` + i + `_sub_total"/></td>
                             <td><input class="form-control scale text-center" id="sale_` + i + `_scale" name="sale[` +
                i + `][scale]" data-product_id="sale_` + i + `_product_id" data-unit_id="sale_` + i +
                ...
                i + `][price]" data-product_id="sale_` + i + `_product_id" data-qty="sale_` + i +
        ...
        $(document).on('change', '.labor_warehouse_id', function() {
            ...
            if (index_no) {
                ...
                let rateInput = $('#sale_' + index_no + '_load_unload_rate');
