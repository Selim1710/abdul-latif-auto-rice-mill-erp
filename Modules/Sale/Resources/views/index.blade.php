    ...
    <div class="container-fluid">
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar"><a href="{{ route('sale.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i>{{__('file.Add New')}}</a></div>
                @endif
            </div>
        </div>
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="{{__('file.Sale Status')}}" name="sale_status" col="col-md-3" class="selectpicker">
                                ...
                                <table id="dataTable" class="table table-bordered table-hover">
                                    <thead class="bg-primary">
                                        <tr>
                                            ...
                                            <th>{{__('file.Sale Type')}}</th>
                                            <th>{{__('file.Sale Status')}}</th>
                                            <th>{{__('file.Sale Qty')}}</th>
                                            <th>{{__('file.Delivery Qty')}}</th>
                                            <th>{{__('file.Return Qty')}}</th>
                                            <th>{{__('file.Sale Amount')}}</th>
                                            <th>{{__('file.Delivery Amount')}}</th>
