                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light"><b>{{__('file.Delivery Invoice')}}</b></div>
                                                    <div class="to">{{ $saleProductDelivery[0]->sale->party_type == 1 ? $saleProductDelivery[0]->sale->party->name : $saleProductDelivery[0]->sale->party_name}}</div>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $saleProductDelivery[0]->sale->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Transport Name')}}: </b>{{ $saleProductDelivery[0]->sale->transport_name }}</div>
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($saleProductDelivery[0]->sale->sale_date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th>{{__('file.Scale')}}</th>
                                            <th>{{__('file.Delivery')}}</th>
                                            <th>{{__('file.Sub Total')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if (!$saleProductDelivery->isEmpty())
                                            @foreach ($saleProductDelivery as $key => $item)
                                                <tr class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $saleProductDelivery[0]->sale->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($saleProductDelivery[0]->sale->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
