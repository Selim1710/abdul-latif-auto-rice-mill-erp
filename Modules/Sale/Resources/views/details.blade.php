                                ...
                                <div>
                                            ...
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    @if($sale->party_type == 1)
                                                        <div class="to">{{ $sale->party->company_name }}</div>
                                                        <div class="to">{{ $sale->party->name }}</div>
                                                        <div class="phone">{{ $sale->party->mobile }}</div>
                                                        @if($sale->party->email)<div class="email">{{ $sale->party->email }}</div>@endif
                                                        @if($sale->party->address)<div class="address">{{ $sale->party->address }}</div>@endif
                                                    @else
                                                        <div class="to">{{ $sale->party_name }}</div>
                                                    @endif
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $sale->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Transport Name')}}: </b>{{ $sale->transport_name }}</div>
                                    ...
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th>{{__('file.Scale')}}</th>
                                            <th>{{__('file.Sale Quantity')}}</th>
                                            <th>{{__('file.Sub Total')}}</th>
                                            <th>{{__('file.Note')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if (!$sale->saleProductList->isEmpty())
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 40%;">
                                                <table>
                                                    <tr>
                                                        <td class="no"><b>{{__('file.Previous Balance')}}</b></td>
                                                        <td class="no">:</td>
                                                        <td class="no">{{number_format($sale->previous_due)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no"><b>{{__('file.Discount')}}</b></td>
                                                        <td class="no">:</td>
                                                        <td class="no">{{number_format($sale->discount)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no"><b>{{__('file.TOTAL')}}</b></td>
                                                        <td class="no">:</td>
                                                        <td class="no">{{number_format($sale->total_sale_sub_total)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no"><b>{{__('file.Paid Amount')}}</b></td>
                                                        <td class="no">:</td>
                                                        <td class="no">{{number_format($sale->paid_amount)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="no"><b>{{__('file.Due')}}</b></td>
                                                        <td class="no">:</td>
                                                        <td class="no">{{number_format($sale->due_amount)}}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
