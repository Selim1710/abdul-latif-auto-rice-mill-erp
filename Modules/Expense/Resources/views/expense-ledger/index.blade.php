        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar"><button type="button" class="btn btn-primary btn-sm mr-3" id="print-invoice"> <i
                                class="fas fa-print"></i>{{ __('file.Print') }}</button></div>
                </div>
            </div>
                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="end_date">{{ __('file.Expense Type') }}</label>
                                <select class="form-control selectpicker" id="expense_type" name="expense_type">
                                    <option value="" selected>Select Please</option>
                                    @foreach (EXPENSE_TYPE_VALUE as $key => $value)
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control selectpicker" id="expense_item_id" name="expense_item_id"
                            ...
                            <div class="col-md-0">
                                <div style="margin-top:28px;">
                                    <button id="btn-reset"
                                        class="btn btn-danger btn-sm btn-elevate btn-icon mr-2 float-left custom-btn"
                                        type="button" data-toggle="tooltip" data-theme="dark" title="Reset"><i
                                            class="fas fa-undo-alt"></i></button>
                                    <button id="btn-filter"
                                        class="btn btn-primary btn-sm btn-elevate btn-icon float-left custom-btn"
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="col-md-12 px-0" style="position: relative;">
                            <div id="invoice" style="width: 100%;">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:left;">
                                                ...
                                                <p style="margin:0;padding:0;">{{ __('file.Signature') }}</p>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                ...
                                <div class="col-md-12 d-none" id="table-loader"
                                    style="position: absolute;top:80px;left:45%;">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#expense_type', function() {
                ...
                $.ajax({
                    url: "{{ route('expense-type-wise-item') }}",
                    type: "GET",
                    data: {
                        expense_type: expense_type,
                    },
                    success: function(expense_item_data) {
                        $('#form-filter #expense_item_id').html('');
                        $('#form-filter #expense_item_id').html(expense_item_data);
        ...
        function report_data() {
            ...
            let expense_type = _('expense_type').value;
            let expense_item_id = _('expense_item_id').value;
