                        ...
                        <form action="" id="tenant_return_product_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 required">
                                    ...
                                    <select class="form-control selectpicker" id="tenant_id" name="tenant_id" data-live-search = "true">
                                        ...
                                        @foreach($tenants as $tenant)
                                            <option value="{{$tenant->id}}">{{$tenant->name.'('.$tenant->mobile.')'}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <table class="table" id="tenantReturnTable">
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    <select class="form-control selectpicker text-center" id="tenant_return_0_warehouse_id" name="tenant_return[0][warehouse_id]" data-live-search = "true">
                                                ...
                                                <td>
                                                    <select class="form-control selectpicker category text-center" id="tenant_return_0_category_id" data-warehouse_id = "tenant_return_0_warehouse_id" data-product_id="tenant_return_0_product_id" data-live-search = "true">
                                                        <option value="">{{__('Please Select')}}</option>
                                                ...
                                                <td>
                                                    <select class="form-control selectpicker product text-center" id="tenant_return_0_product_id" name="tenant_return[0][product_id]" data-warehouse_id = "tenant_return_0_warehouse_id" data-unit_show="tenant_return_0_unit_show" data-unit_id="tenant_return_0_unit_id" data-av_qty="tenant_return_0_av_qty" data-av_scale="tenant_return_0_av_scale" data-live-search = "true"></select>
                                                </td>
                                                <td><input class="form-control bg-primary text-white text-center" id="tenant_return_0_unit_show" readonly/><input type="hidden" id="tenant_return_0_unit_id"/></td>
                                                <td><input class="form-control av_qty text-center bg-primary text-white" id="tenant_return_0_av_qty" readonly/></td>
                                                <td><input class="form-control av_scale text-center bg-primary text-white" id="tenant_return_0_av_scale" readonly/></td>
                                                <td><input class="form-control qty text-center" id="tenant_return_0_qty" name="tenant_return[0][qty]" data-product_id="tenant_return_0_product_id" data-unit_id="tenant_return_0_unit_id" data-av_qty="tenant_return_0_av_qty" data-av_scale="tenant_return_0_av_scale" data-scale="tenant_return_0_scale"/></td>
                                                <td><input class="form-control scale text-center" id="tenant_return_0_scale" name="tenant_return[0][scale]" data-product_id="tenant_return_0_product_id" data-unit_id="tenant_return_0_unit_id" data-av_qty="tenant_return_0_av_qty" data-av_scale="tenant_return_0_av_scale" data-qty="tenant_return_0_qty"/> </td>
                                                <td><input class="form-control retQty" id="tenant_return_0_ret_qty" name="tenant_return[0][ret_qty]" data-av_qty="tenant_return_0_av_qty"/></td>
                                                <td>
                                ...
                                <div class="form-group col-md-12 text-center pt-5">
                                    <a class = "btn btn-danger btn-sm mr-3" href="{{route('tenant.return.product.add')}}"><i class="fas fa-sync-alt"></i>{{__('file.Reset')}}</a>
...
@push('scripts')
    <script>
        ...
        function storeData(){
            ...
            let url      = "{{route('tenant.return.product.store')}}";
            $.ajax({
                url           : url,
                type          : "POST",
                data          : formData,
