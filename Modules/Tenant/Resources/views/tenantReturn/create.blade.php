                                    ...
                                    <div class="form-group">
                                        <table class="table" id="tenantReturnTable">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td><input class="form-control bg-primary text-center" id="tenant_return_0_unit_show" readonly/><input type="hidden" id="tenant_return_0_unit_id"/></td>
                                                <td><input class="form-control av_qty text-center bg-primary" id="tenant_return_0_av_qty" readonly/></td>
                                                <td><input class="form-control av_scale text-center bg-primary" id="tenant_return_0_av_scale" readonly/></td>
