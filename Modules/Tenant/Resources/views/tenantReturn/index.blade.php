            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    @if(permission('tenant-return-add'))
                        <div class="card-toolbar"><a href="{{ route('tenant.return.product.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i>{{__('file.Add New')}}</a></div>
                    @endif
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "{{route('tenant.return.product.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "{{ route('tenant.return.product.delete') }}";
            ...
            $(document).on('click', '.change_status', function () {
                ...
                let row    = table.row($(this).parent('tr'));
                let url    = "{{ route('tenant.return.product.change.status') }}";
