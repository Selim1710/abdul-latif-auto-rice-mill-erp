            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('tenant.delivery.product') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> {{__('file.Back')}}</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="to">{{ $tenantDelivery->tenant->name.'('.$tenantDelivery->tenant->mobile.')' }}</div>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $tenantDelivery->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{__('file.Date')}}: </b>{{ date('d-M-Y',strtotime($tenantDelivery->date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                        @if (!$tenantDelivery->tenantDeliveryProductList->isEmpty())
                                    ...
                                    <div><b>Note : </b>{{$tenantDelivery->note}}</div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $tenantDelivery->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($tenantDelivery->created_at)) }}</p>
                                                    <p class="dashed-border"></p>
