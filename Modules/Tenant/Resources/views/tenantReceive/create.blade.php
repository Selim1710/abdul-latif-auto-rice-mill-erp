                        ...
                        <form action="" id="tenant_receive_product_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <table class="table" id="tenantReceiveTable">
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    <select class="form-control selectpicker text-center" id="tenant_receive_0_warehouse_id" name="tenant_receive[0][warehouse_id]" data-live-search = "true">
                                                ...
                                                <td>
                                                    <select class="form-control selectpicker category text-center" id="tenant_receive_0_category_id" data-product_id="tenant_receive_0_product_id" data-live-search = "true">
                                                        <option value="">{{__('Please Select')}}</option>
                                ...
                                <div class="form-group col-md-12 text-center pt-5">
                                    <a class = "btn btn-danger btn-sm mr-3" href="{{route('tenant.receive.product.add')}}"><i class="fas fa-sync-alt"></i>{{__('file.Reset')}}</a>
