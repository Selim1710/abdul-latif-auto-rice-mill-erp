            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('tenant.receive.product') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="to">
                                                        {{ $tenantReceive->tenant->name . '(' . $tenantReceive->tenant->mobile . ')' }}
                                                    </div>
                                                </div>
                                                <p><b>{{ __('file.Batch No') }} : </b>    {{ $tenantReceive->batch_no ?? '' }}</p>
                                            </td>
                                            <td width="50%" class="text-right">
                                                <h4 class="name m-0">#{{ $tenantReceive->invoice_no }}</h4>
                                                <div class="m-0 date"><b>{{ __('file.Date') }}:
                                                    </b>{{ date('d-M-Y', strtotime($tenantReceive->date)) }}</div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><b
                                                            class="text-uppercase">{{ $tenantReceive->created_by }}</b><br>
                                                        {{ date('d-M-Y h:i:s A', strtotime($tenantReceive->created_at)) }}
                                                    </p>
                                                    <p class="dashed-border"></p>
