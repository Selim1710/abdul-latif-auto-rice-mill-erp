                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="text" class="form-control" id="batch_no" name="batch_no"
                                        value="{{ $tenantReceive->batch_no ?? '' }}" readonly />
                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <select
                                                                    ...
                                                                    id="tenant_receive_{{ $key }}_category_id"
                                                                    data-product_id="tenant_receive_{{ $key }}_product_id"
                                                                    data-live-search = "true">
                                                            ...
                                                            <td>
                                                                <select
                                                                    ...
                                                                    id="tenant_receive_{{ $key }}_product_id"
                                                                    name="tenant_receive[{{ $key }}][product_id]"
                                                                    data-unit_show="tenant_receive_{{ $key }}_unit_show"
                                                            ...
                                                            <td><input class="form-control bg-primary text-center"
                                                                    id="tenant_receive_{{ $key }}_unit_show"
                                                                    value="{{ $item->product->unit->unit_name . '(' . $item->product->unit->unit_code . ')' }}"
                                                                    readonly /><input type="hidden"
                                                                    id="tenant_receive_{{ $key }}_unit_id"
                                                                    value="{{ $item->product->unit->unit_name }}" /></td>
                                                            <td><input class="form-control qty text-center"
                                                                    id="tenant_receive_{{ $key }}_qty"
                                                                    name="tenant_receive[{{ $key }}][qty]"
                                                                    value="{{ $item->qty }}"
                                                                    data-product_id="tenant_receive_{{ $key }}_product_id"
                                                                    data-unit_id="tenant_receive_{{ $key }}_unit_id"
                                                                    data-scale="tenant_receive_{{ $key }}_scale" />
                                                            </td>
                                                            <td><input class="form-control scale text-center"
                                                                    id="tenant_receive_{{ $key }}_scale"
                                                                    name="tenant_receive[{{ $key }}][scale]"
                                                                    value="{{ $item->scale }}"
                                                                    data-product_id="tenant_receive_{{ $key }}_product_id"
                                                                    data-unit_id="tenant_receive_{{ $key }}_unit_id"
...
@push('scripts')
    <script>
        ...
        $(document).on('change', '#tenant_id', function() {
            ...
            let current_tenant_id = parseInt($(this).attr("current_tenant_id"));
            let current_batch_no = $(this).attr("current_batch_no");

            if (current_tenant_id == tenant_id) {
                $('#batch_no').val(current_batch_no);
            }

            if (tenant_id != '' && current_tenant_id != tenant_id) {
                $.ajax({
