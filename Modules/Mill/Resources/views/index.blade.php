            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            <x-form.textbox labelName="{{__('file.Mill')}}" name="name" col="col-md-3" />
                            <x-form.textbox labelName="{{__('file.Address')}}" name="address" col="col-md-3" />
                            <div class="col-md-3">
    ...
    <script>
        ...
        $(document).ready(function(){
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('mill.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
                        data.name           = $("#form-filter #name").val();
                        data.address        = $("#form-filter #address").val();
                        data._token         = _token;
                    }
                },
                "columnDefs": [{
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{route('mill.store.or.update')}}";
