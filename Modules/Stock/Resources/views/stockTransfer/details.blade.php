            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('stock.transfer') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                    ...
                                    <table class="invoice">
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <td class="no"><span class="label label-success label-pill label-inline"
                                                        style="min-width:100px !important;">{{ $details->transferWarehouse->name }}</span>
                                                </td>
                                                <td>{{ $details->transfer_date }}</td>
                                                <td>{{ $details->invoice_no }}</td>
                                                <td class="no"><span class="label label-danger label-pill label-inline"
                                                        style="min-width:100px !important;">{{ $details->receiveWarehouse->name }}</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="invoice">
                                        ...
                                        <tbody>
                                            @foreach ($details->stockTransferWarehouseProductList as $value)
                                                <tr class="text-center">
                                                    <td class="no">{{ $value->party->name ?? '' }}</td>
                                                    <td class="no">{{ $value->purchase->invoice_no ?? '' }}</td>
                                                    <td class="no">{{ $value->product->product_name }}</td>
                                                    <td class="no">{{ $value->product->product_code }}</td>
                                                    <td class="no">
                                                        {{ $value->product->unit->unit_name . '(' . $value->product->unit->unit_code . ')' }}
                                                    </td>
                                                    <td class="no">{{ $value->scale }}</td>
