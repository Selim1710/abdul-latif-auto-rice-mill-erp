        ...
        table = $('#dataTable').DataTable({
            ...
            "buttons": [{
                ...
                customize: function (win) {
                    ...
                    $(win.document.body).find('table thead th').css({'font-size':'15px', 'font-weight':'bold'});
                    $(win.document.body).find('table tfoot tr').css({'background-color':'#034d97','font-size':'20px', 'font-weight':'bold'});
