...
{{--                                    <button id="btn-filter" class="btn btn-primary btn-sm btn-elevate btn-icon float-left custom-btn" type="button" data-toggle="tooltip" data-theme="dark" onclick="balanceSheetData()" title="Search"><i class="fas fa-search"></i></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        </div>
                </div>
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="col-md-12 px-0" style="position: relative;">
                            <div id="invoice" style="width: 100%;">
                                ...
                                <div class="col-md-12 d-none" id="table-loader" style="position: absolute;top:80px;left:45%;"><div><i class="fas fa-spinner fa-spin fa-3x fa-fw text-primary"></i></div></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btn-reset').click(function () {
                ...
                $('#party_id').val('');
                $('#party_id.selectpicker').selectpicker('refresh');
                $('#report_data').empty();
            });
        });
