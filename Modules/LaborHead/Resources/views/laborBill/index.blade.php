                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('labor-bill-add'))
                            <a href="{{ route('labor.bill.create') }}" class="btn btn-primary btn-sm font-weight-bolder"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div style="margin-top:28px;">
                                    <button id="btn-reset"
                                        class="btn btn-danger btn-sm btn-elevate btn-icon mr-2 float-left" type="button"
