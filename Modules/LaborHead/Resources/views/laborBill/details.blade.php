            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('labor.bill') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> {{__('file.Back')}}</a>
                    </div>
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    <table>
                                        <tr class="text-center">
                                            ...
                                            <td class="no">{{$data[0]->invoice_no}}</td>
                                            <td class="no"><button type="button" class="btn btn-primary btn-block">{{__('file.Labor')}}</button></td>
                                            <td class="no">{{$data[0]->laborHead->name}}</td>
                                        </tr>
                                    </table>
                                    <table>
                                        <thead>
                                        <tr class="text-center">
                                            ...
                                            <td class="no"><button type="button" class="btn btn-primary btn-block">{{__('file.Rate')}}</button></td>
                                        ...
                                        @foreach($data as $value)
                                            <tr class="text-center">
                                                <td class="no">{{$value->laborBillRate->name}}</td>
                                                <td class="no">{{$value->rate}}</td>
                                                <td class="no">{{$value->qty}}</td>
