            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('labor.bill') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                                ...
                                <div>
                                    ...
                                    <table>
                                        <tr class="text-center">
                                            ...
                                            <td class="no">{{ $labour_bill->date }}</td>
                                            <td class="no"><button type="button"
                                                    class="btn btn-primary btn-block">{{ __('file.Invoice No') }}</button>
                                            </td>
                                            <td class="no">{{ $labour_bill->invoice_no }}</td>
                                            <td class="no"><button type="button"
                                                    class="btn btn-primary btn-block">{{ __('file.Labor') }}</button></td>
                                            <td class="no">{{ $labour_bill->laborHead->name ?? '' }}</td>
                                        </tr>
                                    </table>
                                    <table>
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Rate') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Qty') }}</button>
                                                </td>
                                                <td class="no"><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Amount') }}</button>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if (!empty($labour_bill->laborBillDetails))
                                                @foreach ($labour_bill->laborBillDetails as $bill_detail)
                                                    <tr class="text-center">
                                                        <td class="no">{{ $bill_detail->warehouse->name ?? '' }}</td>
                                                        <td class="no">{{ $bill_detail->rate }}</td>
                                                        <td class="no">{{ $bill_detail->qty }}</td>
                                                        <td class="no">{{ $bill_detail->amount }}</td>
                                                    </tr>
                                                @endforeach
                                                <tr class="text-center">
                                                    <td  class="no" style="text-align: right" colspan="3">
                                                        {{ __('file.Total Amount') }}
                                                    </td>
                                                    <td class="no">{{ $labour_bill->grand_total ?? '' }}</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
