                    ...
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        ...
                        <div class="row">
                            <div class="col-md-3" id="">
                                ...
                                <select class="form-control js-example-basic-multiple" name="employee_id[]" id="employee_id" data-live-search="true" required multiple>
...
@push('scripts')
    ...
    <script>
        ...
        function account_list(payment_method, key) {
            $.ajax({
                url       : "{{url('account-list')}}/" + payment_method,
                type      : 'GET',
                dataType  : 'JSON',
                success: function(data) {
                    if(data != ''){
                        ...
                        $('#salary_' + key + '_account_id').empty().html(html);
                        $('#salary_' + key + '_account_id').selectpicker('refresh');
                    }
                },
                error: function(xhr, ajaxOption, thrownError) {
                    console.log(thrownError + '\r\n' + xhr.statusText + '\r\n' + xhr.responseText);
        ...
        function store_data() {
            ...
            if (rownumber < 0) {
                ...
                let url = "{{ route('employee.salary.payment.store.or.update') }}";
                $.ajax({
                    url: url,
                    type: "POST",
                    data: formData,
