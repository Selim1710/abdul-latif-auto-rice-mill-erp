...
@section('content')
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('head-add'))
                            <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Head')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> {{__('file.Add New')}}</a>
                        @endif
                    </div>
                </div>
            </div>
    ...
    @include('chartofhead::head.modal')
@endsection
@push('scripts')
    <script>
        let table;
        $(document).ready(function(){
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{route('head.store.or.update')}}";
