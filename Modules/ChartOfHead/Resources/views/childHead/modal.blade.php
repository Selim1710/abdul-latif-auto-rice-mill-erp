            ...
            <form id="store_or_update_form" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <br/>
                            <label for="sub_head_id">{{__('file.Sub Head')}}</label>
                            <Select class="form-control selectpicker" id="sub_head_id" name="sub_head_id" data-live-search = "true">
                                <option value="">{{__('file.Please Select')}}</option>
                            </Select>
                        </div>
                        <div class="col-md-12">
                            <br/>
                            <label for="name">{{__('file.Child Head')}}</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="{{__('file.Child Head')}}"/>
                        </div>
                    </div>
                </div>
