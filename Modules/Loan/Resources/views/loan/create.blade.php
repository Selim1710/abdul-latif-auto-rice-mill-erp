        ...
        <div class="container-fluid">
            ...
            <form id="loan-form" method="post">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="reference_no" name="reference_no" placeholder="{{__('file.Please Enter Reference No')}}"  required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="loan_amount">{{__('file.Loan Amount')}}</label>
                                <input type="text" class="form-control input" id="loan_amount" name="loan_amount" data-type="loan_amount" placeholder="{{__('file.Please Enter Loan Amount')}}"  required="required"/>
                            </div>
                            <div class="col-md-2"><br/>
                                <label for="loan_percentage_percent">{{__('file.Loan Percentage(%)')}}</label>
                                <input type="text" class="form-control input" id="loan_percentage_percent" name="loan_percentage_percent" data-type="loan_percentage_percent" placeholder="{{__('file.Please Enter Loan Percentage')}}" required="required"/>
                            </div>
                            <div class="col-md-2"><br/>
                                <label for="loan_percentage_tk">{{__('file.Loan Percentage(tk)')}}</label>
                                <input type="text" class="form-control input" id="loan_percentage_tk" name="loan_percentage_tk" data-type="loan_percentage_tk" placeholder="{{__('file.Please Enter Loan Percentage')}}" required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="total_amount">{{__('file.Total Amount')}}</label>
                                <input type="text" class="form-control bg-primary" id="total_amount" name="total_amount"  readonly/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="processing_charge">{{__('file.Processing Charge')}}</label>
                                <input type="text" class="form-control" id="processing_charge" name="processing_charge" placeholder="{{__('file.Please Enter Processing Charge')}}"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="misc_charge">{{__('file.MISC Charge')}}</label>
                                <input type="text" class="form-control" id="misc_charge" name="misc_charge" placeholder="{{__('file.Please Enter MISC Charge')}}"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="apply_date">{{__('file.Apply Date')}}</label>
                                <input type="date" class="form-control" id="apply_date" name="apply_date" required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="total_installment_month">{{__('file.Total Installment Month')}}</label>
                                <input type="text" class="form-control input" id="total_installment_month" name="total_installment_month" data-type="total_installment_month" placeholder="{{__('file.Please Enter Total Installment Month')}}" required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="monthly_installment">{{__('file.Monthly Installment')}}</label>
                                <input type="text" class="form-control bg-primary" id="monthly_installment" name="monthly_installment" readonly/>
                            </div>
                            <div class="col-md-4"><br/>
                ...
                <div class="form-group col-md-12 pt-5 text-center">
                    <a class="btn btn-danger btn-sm mr-3" href="{{route('loan.add')}}"><i class="fas fa-sync-alt"></i> Reset</a>
        ...
        $(document).on('input','.input',function(){
            ...
            if(type == 'loan_amount'){
                ...
                if(_('loan_amount').value != ''){
                    ...
                    notification('error','{{__("file.Loan Amount Field Empty")}}');
                }
                ...
                if(_('total_amount').value != ''){
                    ...
                    notification('error','{{__("file.Total Amount Field Empty")}}');
                }
            }
        });
        function store_data(){
