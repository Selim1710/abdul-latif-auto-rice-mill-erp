          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="{{__('file.Bank Name')}}" name="bank_name" required="required" col="col-md-12" placeholder="{{__('file.Bank Name')}}"/>
                    ...
                    <x-form.textbox labelName="{{__('file.Branch')}}" name="branch" required="required" col="col-md-12" placeholder="{{__('file.Branch')}}"/>
                </div>
            </div>
            <!-- /modal body -->
