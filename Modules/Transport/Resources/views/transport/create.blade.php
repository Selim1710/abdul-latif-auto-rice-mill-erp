                        ...
                        <form id="transport-form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control bg-primary text-white" name="invoice_no" id="invoice_no" value="{{ $invoice_no }}" readonly/>
                                </div>
                                <div class="form-group col-md-4 required">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" id="transportTable">
                                        ...
                                        <tr class="text-center">
                                            <td><input type = "text" class="form-control" id="rent_name" name="rent_name" placeholder="{{__('file.Rent Location')}}"/></td>
                                            <td><input type = "text" class="form-control rentAmount" placeholder="0.00"/></td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control expenseAmount" id="transport_0_amount" name="transport[0][amount]" placeholder="0.00"/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control text-right bg-primary text-white" id="rent_amount" name="rent_amount"  placeholder="0.00" readonly></td>
                                            <td class="text-right"><b>{{__('file.Total')}}({{__('file.Expense')}})</b></td>
                                            <td><input type="text" class="form-control text-right bg-primary text-white" id="total_expense" name="total_expense" placeholder="0.00" readonly></td>
                                            <td class="text-center"></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="3"><b>{{__('file.Income')}}</b></td>
                                            <td><input type="text" class="form-control text-right bg-danger text-white" id="income" name="income" placeholder="0.00" readonly></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                <x-form.textarea labelName="{{__('file.Note')}}" name="note" col="col-md-12" />
    ...
    <script>
        ...
        $(document).on('click','.add',function(){
            ...
            html = `<tr class="text-center">
                       ...
                       <td>
                           <input type="text" class="form-control expenseAmount" id="transport_`+ i +`_amount" name="transport[`+ i +`][amount]"/>
                       </td>
                       <td>
                           <button type="button" class="btn btn-primary btn-sm add"  data-toggle="tooltip" data-placement="top" data-original-title="Add More"><i class="fas fa-plus-square"></i></button>
