                        ...
                        <form id="transport-form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control bg-primary" name="invoice_no" id="invoice_no" value="{{ $invoice_no }}" readonly/>
                                </div>
                                <div class="form-group col-md-4 required">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" id="transportTable">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control text-right bg-primary" id="rent_amount" name="rent_amount"  placeholder="0.00" readonly></td>
                                            <td class="text-right"><b>{{__('file.Total')}}({{__('file.Expense')}})</b></td>
                                            <td><input type="text" class="form-control text-right bg-primary" id="total_expense" name="total_expense" placeholder="0.00" readonly></td>
                                            <td class="text-center"></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="3"><b>{{__('file.Income')}}</b></td>
                                            <td><input type="text" class="form-control text-right bg-danger" id="income" name="income" placeholder="0.00" readonly></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
