        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    @if (permission('truck-add'))
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Truck')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i>{{__('file.Add New')}}</a>
                    @endif
                </div>
            </div>
        </div>
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="{{__('file.Truck No')}}." name="truck_no" col="col-md-4" />
...
<script>
    ...
    $(document).ready(function(){
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url" : "{{route('truck.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
                    data.truck_no   = $("#form-filter #truck_no").val();
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('truck.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #truck_no').val(data.truck_no);
                            $('#store_or_update_form #asset_price').val(data.asset_price);
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('truck.change.status') }}";
