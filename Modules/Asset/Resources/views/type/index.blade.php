        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    @if (permission('asset-type-add'))
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Asset Type')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
                        ...
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        @if (permission('asset-type-bulk-delete'))
                                        <th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('asset.type.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                @if (permission('asset-type-report'))
                {
                ...
                },
                {
                    ...
                    'columns': ':gt(0)',
                    "exportOptions": {
                        @if (permission('asset-type-bulk-delete') || permission('product-asset-type-bulk-delete'))
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('asset.type.store.or.update')}}";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('asset.type.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('asset.type.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('asset.type.change.status') }}";
