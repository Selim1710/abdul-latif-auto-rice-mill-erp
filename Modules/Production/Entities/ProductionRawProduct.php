...
{
    protected $fillable  = ['production_id', 'warehouse_id', 'product_id', 'price', 'qty', 'use_qty', 'rest_qty', 'scale', 'use_scale', 'scale_rest', 'pro_qty', 'use_pro_qty', 'rest_pro_qty', 'milling', 'load_unload_rate', 'load_unload_amount'];
