                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('production-add'))
                            <a href="{{route('production.add')}}" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> {{__('file.Add New')}}</a>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="{{__('file.Mill')}}" name="mill_id" col="col-md-4" class="selectpicker">
                                @if (!$mills->isEmpty())
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.change_status',function(){
                ...
                $('#approve_status_modal .modal-title').html('<span>{{__('file.Change Status')}}</span>');
            ...
            $(document).on('click','#status-btn',function(){
                ...
                if(productionId && productionStatus) {
                    $.ajax({
                        ...
                        type      : "POST",
                        data      : {production_id:productionId,production_status:productionStatus,_token:_token},
                        dataType  : "JSON",
                        beforeSend: function(){
                        ...
                        success   : function (data) {
                            ...
                            if (data.status == 'success') { $('#approve_status_modal').modal('hide'); table.ajax.reload(null, false); }
                        },
