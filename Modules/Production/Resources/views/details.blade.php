                            ...
                            <div class="invoice overflow-auto">
                                <div>
                                    ...
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody>
                                        @if (!$data->productionRawProductList->isEmpty())
                                            @foreach ($data->productionRawProductList as $key => $item)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="no">{{ $item->pro_qty }}</td>
                                                    <td class="no">{{ number_format($item->price * $item->qty,2) }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
