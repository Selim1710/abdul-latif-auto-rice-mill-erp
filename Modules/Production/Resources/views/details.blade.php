                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <th><button type="button"
                                                        class="btn btn-primary btn-block">{{ __('file.Batch No') }}</button>
                                                </th>
                                                <th>{{ $data->batch_no }}</th>
                                                <th><button type="button"
