                    ...
                    @foreach ($production->productionRawProductList as $key => $value)
                        <tr class="text-center">
                            ...
                            {{-- <td><input type="text" class="form-control milling bg-primary"
                                    id="raws_{{ $key }}_milling" name="raws[{{ $key }}][milling]"/> </td> --}}
                        </tr>
                    @endforeach
                @endif
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="5"><button type="button"
                            class="btn btn-primary btn-block">{{ __('file.Total Milling Cost') }}</button></td>
                    <td><input type="text" class="form-control bg-primary" id="total_milling_show" value="69000"/> </td>
                </tr>
            </tfoot>
        </table>
    </div>
