                                ...
                                <div>
                                    ...
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="text-center">
                                            <th><button type="button" class="btn btn-primary btn-block">{{__('file.Batch No')}}</button></th>
                                            <th>{{$products[0]->production->batch_no}}</th>
                                            <th><button type="button" class="btn btn-primary btn-block">{{__('file.Production Type')}}</button></th>
                                            <th>{{$products[0]->production->production_type}}</th>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <table class="tableInvoice" border="0" cellspacing="0" cellpadding="0">
